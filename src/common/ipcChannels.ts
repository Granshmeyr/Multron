...
export const showOverlay: string = "show-overlay";
export const hideOverlay: string = "hide-overlay";
export const showOverlayResponse: string = "show-overlay-response";
export const hideOverlayResponse: string = "hide-overlay-response";
export const getTaskbarBounds: string = "get-taskbar-bounds";